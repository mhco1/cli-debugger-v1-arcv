...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 linux-x64 node-v20.5.1
...
_See code: [dist/commands/hello/index.ts](https://github.com/mhco1/mynewcli/blob/v0.0.0/dist/commands/hello/index.ts)_
...
_See code: [dist/commands/hello/world.ts](https://github.com/mhco1/mynewcli/blob/v0.0.0/dist/commands/hello/world.ts)_
